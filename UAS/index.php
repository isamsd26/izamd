...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="index.php"><strong>Seafood</strong> Kota Tegal</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href="news_pembeli.php">NEWS</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">Rumah Makan Mekar</h3>
          <h5>Tegalsari, Kota Tegal
        ...
        <div class="row mb-5 mt-5 ">
          <div class="col-md-6 d-flex justify-content-end">
            <div class="card bg-dark text-white border-light">
              <img src="images/makanan.jpg" height="182px" width="352px" class="card-img" alt="Lihat Daftar Menu">
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card bg-dark text-white border-light">
              <img src="images/kantong.jpg" height="182px" width="352px" class="card-img" alt="Lihat Pesanan">
              <div class="card-img-overlay mt-5 text-center">
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2022 -  Designed byIsa Mas'ud</p>
          </div>
          </div>
