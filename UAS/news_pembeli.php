  ...
  <!-- Menu -->
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 mt-4">
            <div class="card brder-dark">
              <img src="upload/<?php echo $result['image'] ?>" class="card-img-top" alt="..." height="182px" width="352px">
              <div class="card-body">
                <h5 class="card-title font-weight-bold"><?php echo $result['judul_berita'] ?></h5>
                <label class="card-text"><strong>Berita</label><br>
                <a href="<?php echo $result['berita'] ?>" class="btn btn-success btn-sm btn-block ">Link Berita</a>
              </div>
            </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row mt-3">
          ...
          <div class="col-md-3 mt-4">
            <div class="card brder-dark">
              <img src="upload/<?php echo $result['image_yt'] ?>" class="card-img-top" alt="..." height="182px" width="352px">
              <div class="card-body">
                <h5 class="card-title font-weight-bold"><?php echo $result['judul_yt'] ?></h5>
                <label class="card-text"><strong>Video Youtube</label><br>
                <a href="<?php echo $result['link_yt'] ?>" class="btn btn-success btn-sm btn-block ">Link Youtube</a>
              </div>
            </div>
            </div>
          </div>
